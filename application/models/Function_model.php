...
class Function_model extends CI_Model {
	...
	function getAllMenuFunction() {
		$this->db->select("menu.id,menu.name,function.name as function_name,function.description as function_description,function.id as function_id")->from("menu_function");
