...
<body class="sub_page">
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="<?php echo base_url() ?>assets/user/images/hero-bg.jpg" alt="">
    </div>
  ...
  <section class="food_section layout_padding">
        ...
        <?php if(isset($produks)){ ?>
            <?php foreach ($produks as $key => $produk) { ?>
                <div class="col-sm-6 col-lg-4 all <?= $produk->kategori_id ?>">
                    <div class="box">
                        <div class="img-box">
                            <img src="<?php echo base_url('uploads/produk/'.$produk->gambar) ?>" alt="">
                        </div>
                        <div class="detail-box">
                            <h5><?= $produk->nama ?></h5>
                            <div class="options">
                                <h6>Rp. <?= number_format($produk->harga_jual) ?></h6>
                                <a href="#" class="add-to-cart" data-id="<?php echo $produk->id ?>" data-name="<?php echo $produk->nama ?>" data-price="<?php echo $produk->harga_jual ?>" data-image="<?php echo $produk->gambar ?>">
    ...
    <div class="row">
      <div class="col-md-12">
          <form action="<?php echo base_url('Pesanan/checkout') ?>" method="post" id="shopping-cart" class="d-none">
                      ...
                      <div class="col-12">
                          <div class="container mt-4 cart-container">
                              ...
                              <div class="text-center mt-3">
                                  <button type="button" id="checkout" class="btn-checkout mr-2 mb-2">Checkout</button>
                                  <a id="clear-cart" class="btn-clear-cart text-white mb-2">Clear Cart</a>
                              </div>
                          </div>
                      </div>
                  </div>
    ...
    <div class="btn-box">
        <a id="lihat-keranjang" class="notification">
          <span class="text-keranjang">Lihat Keranjang</span>
  ...
  <section class="book_section layout_padding d-none">
    <div class="container">
        ...
        <div class="col-md-12">
          <div class="form_container">
              ...
              <div>
                ...
                <input type="text" class="form-control" placeholder="Total Pembayaran" id="total_pembayaran" readonly/>
              </div>
              <div class="text-center">
                <img width="200" src="<?php echo base_url() ?>assets/images/qris.png" alt="">
              </div>
              <div class="btn_box btn-bayar text-center mt-2">
                <button type="button">
                  Bayar
                </button>
              </div>
  ...
  <!-- jQery -->
  <script src="<?php echo base_url() ?>assets/user/js/jquery-3.4.1.min.js"></script>
  <!-- popper js -->
