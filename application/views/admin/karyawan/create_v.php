            ...
            <form id="form" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="text" id="name" name="name" autocomplete="off" placeholder="Nama Karyawan">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="number" id="no_hp" name="no_hp" autocomplete="off" placeholder="No. HP">
                        </div>
                    </div>
                    <div class="form-group row">
