            ...
            <form id="form" method="post">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select name="id_paket" id="id_paket" class="form-control">
                                ...
                                <option <?php if ($paket->id == $id_paket) {echo "selected";}?> value="<?php echo $paket->id ?>"><?php echo $paket->name ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <textarea name="pesan" id="pesan" class="form-control" cols="30" rows="5" placeholder="Pesan"><?php echo $pesan ?></textarea>
                        </div>
                    </div>
                </div>
